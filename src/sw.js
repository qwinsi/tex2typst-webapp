...
]).map((resource) => SUBDIRECTORY + resource);
...
]).map((resource) => "https://cdn.jsdelivr.net/gh/typst/typst-assets@v0.13.1/files/fonts/" + resource);

const lazyLoadingResources = [
...
setup(APP_VERSION, precacheResources, lazyLoadingResources);
